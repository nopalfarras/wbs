...
<div class="table-responsive">  
    <table class="table table-striped table-sm table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="{{ route('archieveid', $data->id) }}" class="btn btn-info"><i class="bi bi-file-earmark"></i> Detail</span></a>
          </td>
  ...
  <a href="{{ route('dataexport') }}" class="btn btn-info" target="_blank">Export Excel</a>
